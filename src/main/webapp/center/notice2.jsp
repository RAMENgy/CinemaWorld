...
List<BoardDTO> boardList=bDAO.getNoticeList(startRow, pageSize);
...
<tr><th class="tno">No.</th>
    ...
    for(int i=0; i<boardList.size();i++){
    	...
    	%>
<tr onclick="location.href='content2.jsp?num=<%=bDTO.getNum()%>'"><td><%=bDTO.getNum() %></td>
...
if(id.equals("admin")){
	%>
<input type="button" value="글쓰기" class="btn" onclick="location.href='write-notice.jsp'">	
	<%
}
}
%>
